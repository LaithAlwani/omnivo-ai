...
//   MAIL_FROM  (e.g. "Omni AI <no-reply@yourdomain.com>")
...
export const sendPasswordResetEmail = internalAction({
  ...
  handler: async (_ctx, { to, url }) => {
    ...
    await transport.sendMail({
      ...
      to,
      subject: "Reset your Omni AI password",
      text: `Reset your Omni AI password using this link (valid for 30 minutes):\n\n${url}\n\nIf you didn't request this, you can safely ignore this email.`,
      ...
      <tr><td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:480px;background:#17130e;border:1px solid rgba(236,228,216,0.12);border-radius:14px;overflow:hidden;">
          <tr><td style="padding:32px 32px 8px;">
            <div style="font-size:13px;letter-spacing:0.18em;text-transform:uppercase;color:#ff5c1a;font-weight:600;">Omni AI</div>
